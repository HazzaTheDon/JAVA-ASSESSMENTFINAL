...
//		if (input.equalsIgnoreCase("bert") && input.equalsIgnoreCase("bert"));
//		System.out.println("true");
//		if(true Char[] array = input.split());
//		for all i>input.indexOf(Array substring("bert"));
//		
//		return input.substring(input.indexOf(input, fromIndex), endIndex));
		return "";
	}
